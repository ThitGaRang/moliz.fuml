...
public class XmiConstants {
    ...
    public static final String ATTRIBUTE_XMI_HREF = "href"; // used for external references
    public static final String ATTRIBUTE_XMI_IDREF = "idref"; // used for internal references
