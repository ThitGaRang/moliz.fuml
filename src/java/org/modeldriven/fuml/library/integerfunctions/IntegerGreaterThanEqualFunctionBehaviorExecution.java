 ...
 * 
 * <em><b>org::modeldriven::fuml::library::integerfunctions::IntegerGreaterThanEqualFunctionBehaviorExecution</b></em>
 * '. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link IntegerGreaterThanEqualFunctionBehaviorExecution#doIntegerFunction <em>
 * doIntegerFunction</em>}</li>
 * <li>{@link IntegerGreaterThanEqualFunctionBehaviorExecution#new_ <em>new_</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class IntegerGreaterThanEqualFunctionBehaviorExecution extends
    ...
    public Value doIntegerFunction(UMLPrimitiveTypes.intList arguments) {
    	...
    	Debug.println("[doBody] Integer Greater Than or Equal result = " + bv.value);
    	return bv;
    }
