 ...
 * 
 * <em><b>org::modeldriven::fuml::library::integerfunctions::IntegerLessThanEqualFunctionBehaviorExecution</b></em>
 * '. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link IntegerLessThanEqualFunctionBehaviorExecution#doIntegerFunction <em>
 * doIntegerFunction</em>}</li>
 * <li>{@link IntegerLessThanEqualFunctionBehaviorExecution#new_ <em>new_</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class IntegerLessThanEqualFunctionBehaviorExecution extends
    ...
    public Value doIntegerFunction(UMLPrimitiveTypes.intList arguments) {
    	...
    	Debug.println("[doBody] Integer Less Than or Equal result = " + bv.value);
    	return bv;
    }
