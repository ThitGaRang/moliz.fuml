 ...
 * 
 * <em><b>org::modeldriven::fuml::library::integerfunctions::IntegerGreaterThanFunctionBehaviorExecution</b></em>
 * '. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link IntegerGreaterThanFunctionBehaviorExecution#doIntegerFunction <em>
 * doIntegerFunction</em>}</li>
 * <li>{@link IntegerGreaterThanFunctionBehaviorExecution#new_ <em>new_</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class IntegerGreaterThanFunctionBehaviorExecution extends
    ...
    public Value doIntegerFunction(UMLPrimitiveTypes.intList arguments) {
    	...
    	Debug.println("[doBody] Integer Greater Than result = " + bv.value);
    	return bv;
    }
