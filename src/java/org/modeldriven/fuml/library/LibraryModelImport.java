    ...
    protected AssemblerResultsProfile createProfile()
    {
        ...
        return new AssemblerResultsProfile(
            new UmlClass[] { 
                ...
                //(UmlClass)model.getClassifier(Operation.class.getSimpleName()), // don't see why operations and properties should ever be externally referencable from a lib                
    ...
    public void nodeCompleted(StreamNodeEvent event) {
        ...
        if (count == 0) // valid
        {
            ElementGraphAssembler assembler = 
                new ElementGraphAssembler(event.getSource(), getProfile(), false);  
