...
public class ModelConfigDataBinding implements DataBinding {
    ...
    private static Log log = LogFactory.getLog(ModelConfigDataBinding.class);
	...
	public static Class RESOURCE_CLASS = ModelConfigDataBinding.class;

    private ValidatingUnmarshaler validatingUnmarshaler;
	
	public static Class[] FACTORIES = {
        org.modeldriven.fuml.model.config.ObjectFactory.class,
    };
	
	private ModelConfigDataBinding() {}
	
	public ModelConfigDataBinding(BindingValidationEventHandler validationEventHandler)
