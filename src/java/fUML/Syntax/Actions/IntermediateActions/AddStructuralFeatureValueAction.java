...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>fUML::Syntax::Actions::IntermediateActions::AddStructuralFeatureValueAction</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 	 *   <li>{@link AddStructuralFeatureValueAction#setIsReplaceAll <em>setIsReplaceAll</em>}</li>
	 *   <li>{@link AddStructuralFeatureValueAction#setInsertAt <em>setInsertAt</em>}</li>
	 	 *   <li>{@link AddStructuralFeatureValueAction#isReplaceAll <em>isReplaceAll</em>}</li>
