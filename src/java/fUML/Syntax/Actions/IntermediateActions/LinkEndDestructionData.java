...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>fUML::Syntax::Actions::IntermediateActions::LinkEndDestructionData</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 	 *   <li>{@link LinkEndDestructionData#setIsDestroyDuplicates <em>setIsDestroyDuplicates</em>}</li>
	 *   <li>{@link LinkEndDestructionData#setDestroyAt <em>setDestroyAt</em>}</li>
	 	 *   <li>{@link LinkEndDestructionData#isDestroyDuplicates <em>isDestroyDuplicates</em>}</li>
