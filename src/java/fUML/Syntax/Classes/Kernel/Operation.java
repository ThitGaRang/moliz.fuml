 ...
 * <li>{@link Operation#class_ <em>class_</em>}</li>
 * <li>{@link Operation#redefinedOperation <em>redefinedOperation</em>}</li>
 * <li>{@link Operation#datatype <em>datatype</em>}</li>
...
public class Operation extends fUML.Syntax.Classes.Kernel.BehavioralFeature {
    ...
    public int lower = 0;
    public fUML.Syntax.Classes.Kernel.UnlimitedNatural upper = new fUML.Syntax.Classes.Kernel.UnlimitedNatural();
