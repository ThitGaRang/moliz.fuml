...
public class ObjectActivation {
    ...
    public fUML.Semantics.Classes.Kernel.Object_ object = new fUML.Semantics.Classes.Kernel.Object_();
    ...
    public fUML.Semantics.CommonBehaviors.Communications.SignalInstance getNextEvent() {
        ...
        return ((GetNextEventStrategy) this.object.locus.factory.getStrategy("getNextEvent"))
                .getNextEvent(this);
