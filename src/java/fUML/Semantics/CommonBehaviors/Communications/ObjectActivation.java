...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>fUML::Semantics::CommonBehaviors::Communications::ObjectActivation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * <ul>
	 ...
	 *   <li>{@link ObjectActivation#_startObjectBehavior <em>_startObjectBehavior</em>}</li>
	 *   <li>{@link ObjectActivation#_send <em>_send</em>}</li>
	 	 *   <li>{@link ObjectActivation#classifierBehaviorExecutions <em>classifierBehaviorExecutions</em>}</li>
	 *   <li>{@link ObjectActivation#waitingEventAccepters <em>waitingEventAccepters</em>}</li>
