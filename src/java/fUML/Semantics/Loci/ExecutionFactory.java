 ...
 * <em><b>fUML::Semantics::Loci::ExecutionFactory</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public class ExecutionFactory {
    ...
    public fUML.Semantics.Loci.SemanticVisitor instantiateVisitor(
            fUML.Syntax.Classes.Kernel.Element element, String suffix) {
    ...
    public int getStrategyIndex(String name) {
        ...
        // If there is not such strategy, return the size of the strategies
        // list.
