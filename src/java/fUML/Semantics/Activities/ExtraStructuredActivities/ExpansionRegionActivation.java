...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>fUML::Semantics::Activities::ExtraStructuredActivities::ExpansionRegionActivation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 	 *   <li>{@link ExpansionRegionActivation#takeOfferedTokens <em>takeOfferedTokens</em>}</li>
	 *   <li>{@link ExpansionRegionActivation#doAction <em>doAction</em>}</li>
	 *   <li>{@link ExpansionRegionActivation#doStructuredActivity <em>doStructuredActivity</em>}</li>
	 ...
	 *   <li>{@link ExpansionRegionActivation#getExpansionNodeActivation <em>getExpansionNodeActivation</em>}</li>
	 *   <li>{@link ExpansionRegionActivation#numberOfValues <em>numberOfValues</em>}</li>
	 	 *   <li>{@link ExpansionRegionActivation#activationGroups <em>activationGroups</em>}</li>
	 *   <li>{@link ExpansionRegionActivation#inputTokens <em>inputTokens</em>}</li>
	 *   <li>{@link ExpansionRegionActivation#inputExpansionTokens <em>inputExpansionTokens</em>}</li>
	 * </ul>
 * </p>
 *
 * @generated
...
if (super.isReady()) {
    ...
    if (n < 1) {
        ...
        while (ready & i<= region.inputElement.size()) {
            ready = (this.getExpansionNodeActivation(region.inputElement.getValue(i-1)).countUnofferedTokens() == n);
            i = i + 1;
        }
    }
