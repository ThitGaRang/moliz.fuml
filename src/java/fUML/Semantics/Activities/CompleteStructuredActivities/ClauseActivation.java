...
public class ClauseActivation {
    ...
    // Attributes
    public fUML.Semantics.Activities.CompleteStructuredActivities.ConditionalNodeActivation conditionalNodeActivation = new fUML.Semantics.Activities.CompleteStructuredActivities.ConditionalNodeActivation();
    public fUML.Syntax.Activities.CompleteStructuredActivities.Clause clause = new fUML.Syntax.Activities.CompleteStructuredActivities.Clause();
    ...
    public fUML.Semantics.Activities.CompleteStructuredActivities.ClauseActivationList getSuccessors() {
        ...
        for (int i = 0; i < successorClauses.size(); i++) {
            ...
            successors
                    .addValue(this.conditionalNodeActivation.getClauseActivation(successorClause));
        }
