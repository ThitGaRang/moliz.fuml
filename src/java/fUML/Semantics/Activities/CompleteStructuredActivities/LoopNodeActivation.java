...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>fUML::Semantics::Activities::CompleteStructuredActivities::LoopNodeActivation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 	 *   <li>{@link LoopNodeActivation#doStructuredActivity <em>doStructuredActivity</em>}</li>
	 ...
	 *   <li>{@link LoopNodeActivation#createNodeActivations <em>createNodeActivations</em>}</li>
	 *   <li>{@link LoopNodeActivation#makeLoopVariableList <em>makeLoopVariableList</em>}</li>
