...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>fUML::Semantics::Activities::IntermediateActivities::ActivityNodeActivation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * <ul>
	 ...
	 *   <li>{@link ActivityNodeActivation#takeOfferedTokens <em>takeOfferedTokens</em>}</li>
	 ...
	 *   <li>{@link ActivityNodeActivation#createNodeActivations <em>createNodeActivations</em>}</li>
	 *   <li>{@link ActivityNodeActivation#createEdgeInstances <em>createEdgeInstances</em>}</li>
	 *   <li>{@link ActivityNodeActivation#isSourceFor <em>isSourceFor</em>}</li>
	 *   <li>{@link ActivityNodeActivation#getActivityExecution <em>getActivityExecution</em>}</li>
	 *   <li>{@link ActivityNodeActivation#getExecutionContext <em>getExecutionContext</em>}</li>
	 *   <li>{@link ActivityNodeActivation#getExecutionLocus <em>getExecutionLocus</em>}</li>
	 *   <li>{@link ActivityNodeActivation#getNodeActivation <em>getNodeActivation</em>}</li>
...
public  abstract class ActivityNodeActivation    extends fUML.Semantics.Loci.SemanticVisitor    {
...
return allTokens;
   ...
   */
	...
	public  abstract    void fire(fUML.Semantics.Activities.IntermediateActivities.TokenList incomingTokens)  ;
	  /**
   ...
   */
	...
	public      void sendOffers(fUML.Semantics.Activities.IntermediateActivities.TokenList tokens)   {
	 		 	 			// Send offers for the given set of tokens over all outgoing edges (if there are any tokens actually being offered).
...
this.outgoingEdges.addValue(edge);
   ...
   */
	...
	public      void addIncomingEdge(fUML.Semantics.Activities.IntermediateActivities.ActivityEdgeInstance edge)   {
...
return edgeInstance.source == this;
   ...
   */
	...
	public     fUML.Semantics.Activities.IntermediateActivities.ActivityExecution getActivityExecution()   {
	 		 	 			// Return the activity execution that contains this activity node activation, directly or indirectly.
...
return this.getActivityExecution().locus;
   ...
   */
	...
	public     fUML.Semantics.Activities.IntermediateActivities.ActivityNodeActivation getNodeActivation(fUML.Syntax.Activities.IntermediateActivities.ActivityNode node)   {
	 		 	 			// Get the activity node activation corresponding to the given activity node, in the context of this activity node activation.
...
return i - 1;
   ...
   */
	...
	public      void addTokens(fUML.Semantics.Activities.IntermediateActivities.TokenList tokens)   {
