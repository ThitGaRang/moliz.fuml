...
public class ActivityNodeActivationGroup {
    ...
    public void run(
        ...
        for (int i = 0; i < activations.size(); i++) {
            ...
            if (activation instanceof ActionActivation) {
                ...
                isEnabled = (activation instanceof ControlNodeActivation)
    ...
    public void activate(fUML.Syntax.Activities.IntermediateActivities.ActivityNodeList nodes,
    ...
    public void terminateAll() {
        ...
        Debug.println("[terminateAll] Terminating activation group for "
                + (this.activityExecution != null ? "activity "
                        + this.activityExecution.getTypes().getValue(0).name : "node "
    ...
    public fUML.Semantics.Activities.IntermediateActivities.ActivityNodeActivation createNodeActivation(
        ...
        ActivityNodeActivation activation = (ActivityNodeActivation) (this.getActivityExecution().locus.factory
                .instantiateVisitor(node, "Activation"));
    ...
    public fUML.Semantics.Activities.IntermediateActivities.ActivityNodeActivation getNodeActivation(
            fUML.Syntax.Activities.IntermediateActivities.ActivityNode node) {
        // Return the node activation (if any) in this group, or any nested
        // group, corresponding to the given activity node.
