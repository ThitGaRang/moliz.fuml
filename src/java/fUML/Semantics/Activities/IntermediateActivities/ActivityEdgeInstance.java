 ...
 * </li>
 * <li>{@link ActivityEdgeInstance#countOfferedTokens <em>countOfferedTokens
 * </em>}</li>
...
public class ActivityEdgeInstance {
    ...
    public int countOfferedTokens() {
        ...
        // Remove any tokens that have already been consumed and don't include
        // them in the count.
    ...
    /**
     * operation getNextOffer <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */

    public fUML.Semantics.Activities.IntermediateActivities.Offer getNextOffer() {
        // Return the next offer on this edge instance that still has tokens
