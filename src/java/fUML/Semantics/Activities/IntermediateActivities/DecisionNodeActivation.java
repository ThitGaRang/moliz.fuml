...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>fUML::Semantics::Activities::IntermediateActivities::DecisionNodeActivation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 	 *   <li>{@link DecisionNodeActivation#fire <em>fire</em>}</li>
	 *   <li>{@link DecisionNodeActivation#getDecisionValues <em>getDecisionValues</em>}</li>
	 *   <li>{@link DecisionNodeActivation#executeDecisionInputBehavior <em>executeDecisionInputBehavior</em>}</li>
	 *   <li>{@link DecisionNodeActivation#terminate <em>terminate</em>}</li>
	 *   <li>{@link DecisionNodeActivation#isReady <em>isReady</em>}</li>
	 *   <li>{@link DecisionNodeActivation#takeOfferedTokens <em>takeOfferedTokens</em>}</li>
	 *   <li>{@link DecisionNodeActivation#getDecisionInputFlowValue <em>getDecisionInputFlowValue</em>}</li>
	 *   <li>{@link DecisionNodeActivation#getDecisionInputFlowInstance <em>getDecisionInputFlowInstance</em>}</li>
	 *   <li>{@link DecisionNodeActivation#test <em>test</em>}</li>
	 *   <li>{@link DecisionNodeActivation#removeJoinedControlTokens <em>removeJoinedControlTokens</em>}</li>
	 *   <li>{@link DecisionNodeActivation#hasObjectFlowInput <em>hasObjectFlowInput</em>}</li>
	 	 *   <li>{@link DecisionNodeActivation#decisionInputExecution <em>decisionInputExecution</em>}</li>
	 * </ul>
 * </p>
 *
 * @generated
