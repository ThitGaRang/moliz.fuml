...
public class IntegerFunctions extends fUML.Library.PrimitiveFunctions {
    ...
    // Attributes
    public fUML.Syntax.CommonBehaviors.BasicBehaviors.FunctionBehavior integerPlus = new fUML.Syntax.CommonBehaviors.BasicBehaviors.FunctionBehavior();
    public fUML.Syntax.CommonBehaviors.BasicBehaviors.FunctionBehavior integerMinus = new fUML.Syntax.CommonBehaviors.BasicBehaviors.FunctionBehavior();
    public fUML.Syntax.CommonBehaviors.BasicBehaviors.FunctionBehavior integerTimes = new fUML.Syntax.CommonBehaviors.BasicBehaviors.FunctionBehavior();
    public fUML.Syntax.CommonBehaviors.BasicBehaviors.FunctionBehavior integerDivide = new fUML.Syntax.CommonBehaviors.BasicBehaviors.FunctionBehavior();
    public fUML.Syntax.CommonBehaviors.BasicBehaviors.FunctionBehavior integerNegate = new fUML.Syntax.CommonBehaviors.BasicBehaviors.FunctionBehavior();
    ...
    public IntegerFunctions(fUML.Syntax.Classes.Kernel.PrimitiveType integerType,
