...
public abstract class PrimitiveBehaviors {
    ...
    protected fUML.Syntax.CommonBehaviors.BasicBehaviors.OpaqueBehavior createPrimitiveBehavior(
        ...
        return this.addPrimitiveBehavior(name, parameters, new OpaqueBehavior(), implementation,
                factory);
     ...
     * @generated
     */
    protected fUML.Syntax.Classes.Kernel.Parameter createInputParameter(String name,
