...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>fUML::Library::PrimitiveBehaviors</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 	 *   <li>{@link PrimitiveBehaviors#createPrimitiveBehavior <em>createPrimitiveBehavior</em>}</li>
	 *   <li>{@link PrimitiveBehaviors#createInputParameter <em>createInputParameter</em>}</li>
	 *   <li>{@link PrimitiveBehaviors#createReturnParameter <em>createReturnParameter</em>}</li>
	 *   <li>{@link PrimitiveBehaviors#setMultiplicity <em>setMultiplicity</em>}</li>
	 *   <li>{@link PrimitiveBehaviors#addPrimitiveBehavior <em>addPrimitiveBehavior</em>}</li>
	 	 * </ul>
 * </p>
 *
 * @generated
