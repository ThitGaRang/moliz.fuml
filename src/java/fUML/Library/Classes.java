...
public class Classes {
    ...
    protected void addAttribute(fUML.Syntax.Classes.Kernel.Class_ owner, String name,
            fUML.Syntax.Classes.Kernel.Type type,
            fUML.Syntax.Classes.Kernel.VisibilityKind visibility, boolean isComposite) {
    ...
    protected void addParameter(fUML.Syntax.Classes.Kernel.Operation operation, String name,
    ...
    protected void addGeneralization(fUML.Syntax.Classes.Kernel.Class_ specific,
