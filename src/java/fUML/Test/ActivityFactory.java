...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>fUML::Test::ActivityFactory</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * <ul>
	 ...
	 *   <li>{@link ActivityFactory#createLiteralInteger <em>createLiteralInteger</em>}</li>
	 ...
	 *   <li>{@link ActivityFactory#createInstanceGetter <em>createInstanceGetter</em>}</li>
	 *   <li>{@link ActivityFactory#getProperty <em>getProperty</em>}</li>
	 *   <li>{@link ActivityFactory#createLiteralBoolean <em>createLiteralBoolean</em>}</li>
	 ...
	 *   <li>{@link ActivityFactory#createSimpleDecision <em>createSimpleDecision</em>}</li>
	 ...
	 *   <li>{@link ActivityFactory#createIdentityTester <em>createIdentityTester</em>}</li>
	 *   <li>{@link ActivityFactory#createObjectCreater <em>createObjectCreater</em>}</li>
	 *   <li>{@link ActivityFactory#createObjectDestroyer <em>createObjectDestroyer</em>}</li>
	 *   <li>{@link ActivityFactory#createWriterReader <em>createWriterReader</em>}</li>
	 *   <li>{@link ActivityFactory#createAttributeWriter <em>createAttributeWriter</em>}</li>
	 *   <li>{@link ActivityFactory#createAttributedCaller <em>createAttributedCaller</em>}</li>
	 ...
	 *   <li>{@link ActivityFactory#createOperationCaller <em>createOperationCaller</em>}</li>
	 *   <li>{@link ActivityFactory#createPolymorphicOperationCaller <em>createPolymorphicOperationCaller</em>}</li>
