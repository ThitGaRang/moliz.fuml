...
public class ClassifierFactory extends fUML.Test.Test {
     ...
     * @generated
     */
    public void addAttribute(String classifierName, String attributeName, String attributeTypeName,
            boolean isComposite) {
        ...
        if (attributeType == null) {
            Debug
                    .println("[addAttribute] " + attributeTypeName
     ...
     * @generated
     */
    public void addEnd(String associationName, String endName, String endTypeName,
            boolean isComposite) {
     ...
     * @generated
     */
    public void addOperation(String className, String baseClassName, String operationName,
            String methodName) {
        NamedElement element = this.environment.getElement(className);
        ...
        if (!baseClassName.equals("")) {
            ...
            if (redefinedOperation == null) {
                Debug.println("[addOperation] " + operationName + " is not an operation of "
                        + baseClassName + ".");
                return;
            }
